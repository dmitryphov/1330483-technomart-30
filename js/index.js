...
const prev = document.querySelector('.arrow-right');
const next = document.querySelector('.arrow-left');
...
const serviceSlides = document.querySelectorAll(".services-description-slider");
...
const buyButtons = document.querySelectorAll(".catalog-btn_buy");
